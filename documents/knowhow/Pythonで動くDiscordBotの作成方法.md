...
![Discord Developer Portal](img/image.png)
...
![SCOPESの右欄の上から3番目](img/image-1.png)
...
![RESET BOT'S TOKEN?](img/image-2.png)
...
![Message Content Intent](img/image-3.png)
...
- 「こんにちはーー」と表示されれば成功
- Bot実行中に招待したサーバーでメッセージを送信すると，同じ内容のリプライが返ってくる