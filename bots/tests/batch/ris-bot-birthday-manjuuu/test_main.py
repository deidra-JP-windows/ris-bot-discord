...
import sys
import os
sys.path.append(os.path.join(os.path.dirname(__file__), '../../../../bots/batch/ris-bot-birthday-manjuuu'))
import main
...
class TestMain(unittest.TestCase):
    ...
    def test_main(self, mock_print):
        ...
        with patch('main.BirthdayNotificationService.birthday_notification_main', return_value=None) as mock_birthday, \
             patch('main.YouTubePickupSongService.add_youTube_playlist_main', return_value=None) as mock_youtube, \
             patch('main.QiitaNewsService.get_qiita_news_main', return_value=None) as mock_qiita, \
             patch.object(main.client, 'close', return_value=None) as mock_close:
