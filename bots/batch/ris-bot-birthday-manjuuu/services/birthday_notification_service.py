...
class BirthdayNotificationService:
    ...
    async def birthday_notification_main(self, client: 'discord.Client'):
        """
        ...
        async for message in client.get_channel(self.READ_BIRTHDAY_CHANNEL_ID).history(limit=None):
            # Bot自身のメッセージは除外
